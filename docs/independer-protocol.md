...
Designed for Actor background-job. A1 tries whole process three times. A2 goes automatic in background if no data received from A1. If A2 receive data from step 1 - ignore data.
